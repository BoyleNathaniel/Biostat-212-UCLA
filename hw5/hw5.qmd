...
as well as the set of points for which $1+3X_1−X_2<0$.

On the same plot, sketch the hyperplane $−2+X_1+2X_2=0$
Indicate the set of points for which $−2+X_1+2X_2>0$
as well as the set of points for which $−2+X_1+2X_2<0$
...
Sketch the curve $(1 + X_1)^2 + (2 − X2)^2 = 4$.
